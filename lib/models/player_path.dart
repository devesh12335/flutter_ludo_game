...
final List<Cell> mainLoop = const [
  ...
  Cell(13,6), Cell(12,6), Cell(11,6), Cell(10,6), Cell(9,6), Cell(8,6),
...
List<Cell> _rotatedLoop(int startIndex) {
  final List<Cell> out = [];
  out.addAll(mainLoop.sublist(startIndex));
  out.addAll(mainLoop.sublist(0, startIndex));
  return out;
}
...
final List<Cell> yellowHome= const [ Cell(7,13), Cell(7,12), Cell(7,11), Cell(7,10), Cell(7,9), Cell(7,8) ];
final List<Cell> blueHome  = const [ Cell(13,7), Cell(12,7), Cell(11,7), Cell(10,7), Cell(9,7), Cell(8,7) ];
...
Map<LudoPlayer, List<Cell>> buildPlayerPaths() {
  return {
    LudoPlayer.red:    [..._rotatedLoop(entryIndex[LudoPlayer.red]!),   ...redHome],
    LudoPlayer.green:  [..._rotatedLoop(entryIndex[LudoPlayer.green]!), ...greenHome],
    LudoPlayer.yellow: [..._rotatedLoop(entryIndex[LudoPlayer.yellow]!),...yellowHome],
    LudoPlayer.blue:   [..._rotatedLoop(entryIndex[LudoPlayer.blue]!),  ...blueHome],
  };
}
}

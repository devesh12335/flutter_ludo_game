...
class _GameState extends State<Game> {
  ...
  dice.LudoPlayer _playerFromColor(board.LudoColor c) {
    switch (c) {
      case board.LudoColor.red:
        return dice.LudoPlayer.red;
      case board.LudoColor.green:
        return dice.LudoPlayer.green;
      case board.LudoColor.yellow:
        return dice.LudoPlayer.yellow;
      case board.LudoColor.blue:
        return dice.LudoPlayer.blue;
    }
  }
